...
-- Review existing column names before running on production MySQL. MySQL 8.0+
-- supports ADD COLUMN IF NOT EXISTS; older versions need manual checks.
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS questionnaire_completed TINYINT(1) DEFAULT 0;
...
ALTER TABLE websites ADD COLUMN IF NOT EXISTS summary VARCHAR(500);
ALTER TABLE websites ADD COLUMN IF NOT EXISTS description TEXT;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS is_free TINYINT(1) DEFAULT 1;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS need_login TINYINT(1) DEFAULT 0;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS region VARCHAR(32) DEFAULT 'domestic';
ALTER TABLE websites ADD COLUMN IF NOT EXISTS quality_score FLOAT DEFAULT 0;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS recommend_level INT DEFAULT 0;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS click_count INT DEFAULT 0;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS favorite_count INT DEFAULT 0;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS rating_avg FLOAT DEFAULT 0;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS status VARCHAR(20) DEFAULT 'approved';
ALTER TABLE websites ADD COLUMN IF NOT EXISTS created_at DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE websites ADD COLUMN IF NOT EXISTS updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
