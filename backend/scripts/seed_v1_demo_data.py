...
SITE_OCCUPATIONS = {
    "ChatGPT": ["前端开发", "后端开发", "AI 应用开发", "大模型工程师", "产品经理", "数据分析师", "运营", "技术运营", "学生", "教师", "自媒体创作者", "其他"],
    "Claude": ["前端开发", "后端开发", "AI 应用开发", "大模型工程师", "产品经理", "数据分析师", "运营", "技术运营", "学生", "教师", "自媒体创作者", "其他"],
    "Gemini": ["AI 应用开发", "大模型工程师", "产品经理", "数据分析师", "运营", "学生", "教师", "自媒体创作者", "其他"],
    "Perplexity": ["AI 应用开发", "大模型工程师", "产品经理", "数据分析师", "学生", "教师"],
    "Poe": ["前端开发", "后端开发", "AI 应用开发", "大模型工程师", "运营", "学生", "自媒体创作者"],
    "Kimi": ["学生", "产品经理", "运营", "教师", "数据分析师"],
    "通义千问": ["学生", "前端开发", "后端开发", "AI 应用开发", "大模型工程师", "运营", "教师", "自媒体创作者"],
    "秘塔 AI 搜索": ["学生", "产品经理", "运营", "教师", "自媒体创作者", "数据分析师"],
    "豆包": ["学生", "运营", "教师", "自媒体创作者"],
    "Midjourney": ["UI/UX 设计师", "运营", "自媒体创作者"],
    "Runway": ["UI/UX 设计师", "运营", "自媒体创作者"],
    "Stable Diffusion": ["AI 应用开发", "大模型工程师", "UI/UX 设计师", "运营", "自媒体创作者"],
    "GitHub": ["前端开发", "后端开发", "AI 应用开发", "大模型工程师", "数据分析师", "技术运营"],
    "MDN Web Docs": ["学生", "前端开发"],
    "Vue 官方文档": ["学生", "前端开发"],
    "Flask 官方文档": ["学生", "后端开发", "AI 应用开发", "技术运营"],
    "LeetCode": ["学生", "前端开发", "后端开发", "AI 应用开发", "数据分析师"],
    "Figma": ["产品经理", "UI/UX 设计师", "前端开发"],
    "Canva": ["学生", "产品经理", "UI/UX 设计师", "运营", "教师", "自媒体创作者"],
    "Iconfont": ["前端开发", "UI/UX 设计师"],
    "Unsplash": ["UI/UX 设计师", "运营", "教师", "自媒体创作者"],
    "Notion": ["产品经理", "数据分析师", "运营", "技术运营", "学生", "教师", "自媒体创作者", "其他"],
    "飞书": ["产品经理", "数据分析师", "运营", "技术运营", "教师"],
    "ProcessOn": ["学生", "产品经理", "教师", "数据分析师"],
    "Stack Overflow": ["前端开发", "后端开发", "AI 应用开发", "大模型工程师", "技术运营"],
    ...
    "Khan Academy": ["学生", "教师"],
    "中国大学 MOOC": ["学生", "教师"],
    "Kaggle": ["大模型工程师", "数据分析师", "学生"],
    "Tableau": ["数据分析师", "产品经理"],
    "Power BI": ["数据分析师", "产品经理"],
    "Jupyter": ["后端开发", "AI 应用开发", "大模型工程师", "数据分析师"],
    "SQL 教程": ["数据分析师", "后端开发"],
    "Notion 产品文档": ["产品经理", "运营"],
    "飞书产品协作": ["产品经理", "运营", "技术运营"],
    "ProcessOn 产品流程": ["产品经理", "数据分析师", "运营"],
    "Canva 运营设计": ["产品经理", "UI/UX 设计师", "运营", "自媒体创作者"],
    "Figma 原型设计": ["前端开发", "产品经理", "UI/UX 设计师"],
    "墨刀": ["产品经理", "UI/UX 设计师"],
    "ProcessOn 原型流程": ["产品经理", "UI/UX 设计师"],
    "Canva 原型表达": ["产品经理", "UI/UX 设计师"],
}
...
SITES = [
    ...
    },
    {
        ...
        "summary": "面向资料检索和知识整理的 AI 搜索工具。",
        "description": "适合查找资料、提炼要点、辅助学习和研究型工作。",
        "category": "AI工具",
        "tags": ["AI", "学习", "效率"],
        "quality_score": 89,
        "recommend_level": 4,
        ...
        with conn.cursor() as cursor:
            ...
            for site in SITES:
                ...
                if {"site_id", "occupation"}.issubset(occupation_columns):
                    for occupation in SITE_OCCUPATIONS.get(site["name"], []):
