<template>
  <div class="dmca-container block-shadow">
    <h2>版权申诉与 DMCA 投诉</h2>
    <p class="notice">如果您认为本站上的内容侵犯了您的版权，请填写下方表单，我们将依法核实并下架侵权内容。</p>
    ...
    <form @submit.prevent="submitDMCA" class="dmca-form">
      ...
      <div class="form-group">
        ...
        <textarea v-model="form.desc" required class="auth-input" rows="5"></textarea>
      </div>
...
<style scoped>
.dmca-container { max-width: 800px; margin: 40px auto; padding: 40px; background: white; border-radius: 16px; }
.notice { color: #eab308; background: #fef9c3; padding: 15px; border-radius: 8px; margin-bottom: 20px; font-size: 14px;}
.dmca-form .form-group { margin-bottom: 20px; }
.dmca-form label { display: block; margin-bottom: 8px; font-weight: bold; color: #334155; }
</style>